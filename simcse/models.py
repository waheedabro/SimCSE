...
class HierarchicalBert(nn.Module):
    ...
    def __init__(self, encoder, max_segments=64, max_segment_length=128):
        ...
        self.seg_pos_embeddings = nn.Embedding(max_segments + 1, encoder_hidden_size,
                                               padding_idx=0,
                                               _weight=sinusoidal_init(max_segments + 1, encoder_hidden_size))
        # Init segment-wise transformer-based encoder
        self.seg_encoder = nn.Transformer(d_model=encoder_hidden_size,
                                          nhead=12,
                                          batch_first=True, dim_feedforward=intermediate_size,
